...
def layout(title, path, description, body, image='/cover.jpg'):
    ...
    return ('<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>' + html.escape(page) + '</title><meta name="description" content="' + html.escape(description) + '"><link rel="canonical" href="' + SITE + path + '"><link rel="icon" href="/cover.jpg"><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;600;700&display=swap" rel="stylesheet"><meta property="og:title" content="' + html.escape(title) + '"><meta property="og:image" content="' + html.escape(abs_img) + '"><link rel="stylesheet" href="/styles.css"></head><body><header><div class="wrap nav"><a class="brand" href="/"><img src="/cover.jpg" alt="">Behind the Facade</a><nav><a href="/episodes/">Episodes</a><a href="/articles/">Articles</a><a href="/hosts/">Hosts</a><a href="/guests/">Guests</a><a href="/pitch/">Be a guest</a><a href="' + SHOW['youtube'] + '" target="_blank" rel="noreferrer">YouTube</a></nav></div></header>' + body + '<footer><div class="wrap foot"><div><strong style="color:#fff">Behind the Facade</strong><div>Melbourne construction podcast - Jake Gorry and Daniel Alizzi</div><div class="foot-links"><a href="' + SHOW['spotify'] + '">Spotify</a><a href="' + SHOW['apple'] + '">Apple</a><a href="' + SHOW['youtube'] + '">YouTube</a><a href="/feed">RSS</a><a href="mailto:contact@thebtfpodcast.com">contact@thebtfpodcast.com</a></div></div><form class="subscribe" name="subscribe" method="POST" data-netlify="true" netlify-honeypot="bot-field"><input type="hidden" name="form-name" value="subscribe"><p style="display:none"><label>Do not fill this out <input name="bot-field"></label></p><label>Subscribe to the mailing list<span class="sub-row"><input type="email" name="email" required placeholder="Email address"><button class="btn" type="submit">Subscribe</button></span></label><p class="sub-note">New episodes and notes sent to the show.</p></form></div></footer></body></html>')
